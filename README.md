...
2. **detailed-project-plan-standalone.html** - Full cloud-enabled project plan (from dera-residence-cloud.html)
3. **tile-calculator.html** - Standalone tile calculator with 9,011 SF coverage
4. **contractor-organizer.html** - Complete database of 186+ SW Florida contractors
...
2. Drag and drop all four HTML files:
   - index.html
...
Your Firebase credentials are already configured in all files. The system uses Firebase Authentication to protect access to all content.

**IMPORTANT: Site-Wide Authentication**
- Users must log in before accessing ANY content on the main dashboard
- Authentication modal appears immediately on page load
- All tabs require authentication
- Each standalone tool (detailed project plan, tile calculator, contractor organizer) can be accessed independently
